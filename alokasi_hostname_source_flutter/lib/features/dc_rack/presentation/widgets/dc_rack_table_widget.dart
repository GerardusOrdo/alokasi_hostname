...
import '../pages/dc_rack_edit_page_tab.dart';

class DcRackTableWidget extends StatelessWidget {
  @override
    ...
    return GetBuilder<DcRackPloc>(
      builder: (_) => SingleChildScrollView(
        child: PaginatedDataTable(
          ...
          source: _DcRackDataSourceRestAPI(),
...
class _DcRackDataSourceRestAPI extends DataTableSource {
  @override
  DataRow getRow(int index) => Get.find<DcRackPloc>().getDataTableRow(index);

  @override
  bool get isRowCountApproximate => false;

  @override
  int get rowCount => Get.find<DcRackPloc>().dcRackTable.dcRack.length;

  @override
  int get selectedRowCount => Get.find<DcRackPloc>().selectedDataCount;
}
