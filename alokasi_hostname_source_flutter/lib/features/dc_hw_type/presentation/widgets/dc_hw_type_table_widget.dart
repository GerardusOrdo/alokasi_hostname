...
import '../pages/dc_hw_type_edit_page_tab.dart';

class DcHwTypeTableWidget extends StatelessWidget {
  @override
    ...
    return GetBuilder<DcHwTypePloc>(
      builder: (_) => SingleChildScrollView(
        child: PaginatedDataTable(
          ...
          source: _DcHwTypeDataSourceRestAPI(),
...
class _DcHwTypeDataSourceRestAPI extends DataTableSource {
  @override
  DataRow getRow(int index) => Get.find<DcHwTypePloc>().getDataTableRow(index);

  @override
  bool get isRowCountApproximate => false;

  @override
  int get rowCount => Get.find<DcHwTypePloc>().dcHwTypeTable.dcHwType.length;

  @override
  int get selectedRowCount => Get.find<DcHwTypePloc>().selectedDataCount;
}
